...
$_['entry_eql_sig'] = 'Знак равенства';
//
$_['entry_tot_prc'] = 'Общая цена товара';
$_['entry_tot_opt'] = 'Общая цена опций';
$_['entry_hid_pfx'] = 'Убрать префиксы опций';
...
//
$_['help_tot_prc'] = 'Показывать итоговую цена товара с учётом указанного количества';
$_['help_tot_opt'] = 'Отображать цену товарных опций с учётом указанного количества товара';
$_['help_hid_pfx'] = 'Скрывать префиксы и показывать общую стоимость товарных опций (кроме checkbox)';
