...
$_['entry_tab_vie'] = 'Вид и Поведение';
$_['entry_tab_lng'] = 'Языковые Настройки';
$_['entry_tab_css'] = 'Cтили CSS';
$_['entry_tab_spt'] = 'Поддержка';
//
$_['entry_status'] = 'Статус';
$_['entry_prc_rat'] = 'Скидки для опций';
$_['entry_eql_sgn'] = 'Знак равенства';
//
$_['entry_tot_qty'] = 'Пересчитывать по кол-ву (итого)';
$_['entry_opt_qty'] = 'Пересчитывать по кол-ву (опции)';
$_['entry_hid_pfx'] = 'Скрывать префиксы';
$_['entry_text_free'] = 'Бесплатно';
$_['entry_fade_duration'] = 'Анимация, мс';
//
...
$_['help_prc_rat'] = 'Пересчитывать цены опций пропорционально скидкам на основную цену товара';
$_['help_eql_sgn'] = 'Использовать знак равенства в качестве префикса товарных опций';
//
$_['help_tot_qty'] = 'Отображать цену товара с учётом указанного количества';
$_['help_opt_qty'] = 'Отображать цену опций товара с учётом указанного количества товара';
$_['help_hid_pfx'] = 'Скрывать префиксы и показывать общую стоимость опций (кроме checkbox)';
$_['help_text_free'] = 'Текст для опций с нулевой стоимостью. Если не нужно - оставить поле пустым';
$_['help_fade_duration'] = 'Анимации в мс при изменении отображаемой цены товара';
//
