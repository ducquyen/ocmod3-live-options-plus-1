...
$_['entry_price_ratio'] = 'Знижки для опцій';
...
$_['help_price_ratio'] = 'Змінювати вартість опцій пропорційно до знижок';
$_['help_equal_sign'] = 'Використовувати знак рівності в якості префікса для опцій';
$_['help_log'] = 'Писати журнал у консоль браузера';
//
$_['help_product_total'] = 'Відображати загальну вартість товару з врахуванням обраних опцій та кількості товару';
$_['help_option_total'] = 'Відображати загальну ціну товарних опції з врахуванням обраної кількості товару';
$_['help_hide_prefix'] = 'Приховати префікси та відображати загальну вартість для опцій (окрім checkbox)';
$_['help_text_free'] = 'Текст для безкоштовних опцій. Можно залишити порожнім';
$_['help_fade'] = 'Анімаційна затримка в мс при зміні ціни';
//
